...
| **M03 — Heartbeat watchdog** | ⏭️ **Skipped 2026-05-24.** The original goal was to stop a runaway CR base on Python crash. After the 2026-05-24 hardware swap to a position-servo base, position servos hold their last commanded angle when packets stop — the failure mode this task addressed no longer exists. | **Fri 5/29** |
